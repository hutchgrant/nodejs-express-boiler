...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   ```bash
   # clone your fork
   git clone https://github.com/<your-username>/nodejs-express-boiler.git
   # change directory to the repository folder
   cd site
   # set the official nodejs-express-boiler repo to a remote branch called "upstream"
   git remote add upstream https://github.com/hutchgrant/nodejs-express-boiler.git
   ```
